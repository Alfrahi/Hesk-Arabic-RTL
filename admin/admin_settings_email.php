        ...
        <div class="settings__form form">
            ...
            <section class="settings__form_block">
                ...
                <div class="checkbox-group row">
                    ...
                    <span style="margin-right: 24px;"><i><?php echo $hesklang['disabled']; ?></i> - <?php echo $hesklang['imap_not']; ?></span>
                    <?php $onload_div = 'none'; ?>
                    <?php else: ?>
                    <label class="switch-checkbox">
            ...
            <section class="settings__form_block">
                ...
                <div class="form-group short">
                    ...
                    <div style="margin-right: 12px;"><?php echo sprintf($hesklang['loop_info'], $hesklang['loopt']); ?></div>
                </div>
                <div class="form-group short">
                    <label>
            ...
            <section class="settings__form_block">
                ...
                <div id="detect_typos" style="display:<?php echo $onload_div; ?>">
                    <div class="form-group">
                        ...
                        <textarea style="margin-right: 24px;" name="s_email_providers" id="d1" class="form-control"><?php echo implode("\n", $hesk_settings['email_providers']); ?></textarea>
                    </div>
                </div>
            </section>
            <section class="settings__form_block">
                ...
                <div class="checkbox-group">
                    ...
                    <div class="checkbox-list">
                        ...
                        <div id="skip_notify" style="margin-right:25px;display:<?php echo $hesk_settings['notify_new'] ? 'block' : 'none'; ?>">
                            <div class="checkbox-custom">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" name="s_notify_spam_tags" rows="5" cols="40" style="margin-right:25px;"><?php echo hesk_htmlspecialchars( implode("\n", $hesk_settings['notify_spam_tags']) ); ?></textarea>
                            </div>
                        </div>
                        <div class="checkbox-custom">
