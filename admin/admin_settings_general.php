        ...
        <div class="settings__form form">
            <section class="settings__form_block">
                ...
                <div class="form-group">
                    ...
                    <button type="button" class="btn btn--blue-border" style="margin-right: 20px" ripple="ripple"
                ...
                <div class="checkbox-group">
                    ...
                    <div class="checkbox-list">
                        ...
                        <div id="admin_css" style="margin-right:25px;display:<?php echo $hesk_settings['admin_css'] ? 'block' : 'none'; ?>">
