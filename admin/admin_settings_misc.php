        ...
        <div class="settings__form form">
            <section class="settings__form_block">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" style="max-width: 200px; margin-left: 5px;" id="s_format_time" name="s_format_time" maxlength="255" value="<?php echo $hesk_settings['format_time']; ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" style="max-width: 200px; margin-left: 5px;" id="s_format_date" name="s_format_date" maxlength="255" value="<?php echo $hesk_settings['format_date']; ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" style="max-width: 200px; margin-left: 5px;" id="s_format_timestamp" name="s_format_timestamp" maxlength="255" value="<?php echo $hesk_settings['format_timestamp']; ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" style="max-width: 200px; margin-left: 5px;" id="s_format_datepicker_js" name="s_format_datepicker_js" maxlength="255" value="<?php echo $hesk_settings['format_datepicker_js']; ?>">
