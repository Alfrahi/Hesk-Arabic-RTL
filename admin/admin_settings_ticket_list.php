            ...
            <div class="radio-group">
                ...
                <div class="radio-list">
                    ...
                    <div class="radio-custom">
                        ...
                        <input type="text" class="form-control" style="max-width: 200px; margin-right: 5px;" id="s_format_submitted" name="s_format_submitted" maxlength="255" value="<?php echo $hesk_settings['format_submitted']; ?>">
                    </div>
                </div>
            </div>
            <div class="radio-group">
                ...
                <div class="radio-list">
                    ...
                    <div class="radio-custom">
                        ...
                        <input type="text" class="form-control" style="max-width: 200px; margin-right: 5px;" id="s_format_updated" name="s_format_updated" maxlength="255" value="<?php echo $hesk_settings['format_updated']; ?>">
                    </div>
                </div>
            </div>
        </section>
