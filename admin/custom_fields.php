...
$hesk_settings['datepicker']['#dmin']['position'] = 'right top';
$hesk_settings['datepicker']['#dmax']['position'] = 'right bottom';
?>
            ...
            <div id="date" style="display:<?php echo ($type == 'date') ? 'block' : 'none' ?>">
                <div class="form-group">
                    ...
                    <div class="radio-custom">
                        ...
                        <section class="param calendar" style="margin-right: 10px;">
                    ...
                    <div class="radio-custom">
                        ...
                        <div class="dropdown-select center out-close" style="margin-right: 5px;">
                        ...
                        <input type="text" class="form-control" style="height: inherit; width: inherit; margin-right: 5px; margin-left: 5px;"
                ...
                <div class="form-group">
                    ...
                    <div class="radio-custom">
                        ...
                        <input type="text"
                               ...
                               style="height: inherit; width: inherit; margin-right: 5px;"
