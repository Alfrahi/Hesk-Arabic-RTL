        ...
        <div class="article__detalies">
            ...
            <ul class="article__detalies_list">
                ...
                <li>
                    ...
                    <div class="descr">
                        <a style="margin-right: 0" href="<?php echo $link; ?>"><?php echo $article['cat_name']; ?></a>
                    </div>
                </li>
                <li>
...
function hesk_show_kb_category($catid, $is_search = 0) {
    ...
    if ($is_search == 0)
    {
		...
		if ($catid == 1)
	    {
	    	echo '<span style="padding-right: 16px">' . $hesklang['priv'] . '</span>';
	    }
    }
	...
	if ($thiscat['parent'])
	{
		...
		echo '<span class="homepageh3" style="font-size: 1.4rem; padding-right: 16px">'.$hesklang['kb_cat'].': '.$thiscat['name'].'
