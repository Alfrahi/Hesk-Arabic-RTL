...
EOC;
                ...
                <div class="actions" style="display: flex; margin-top: 16px;">
                    ...
                    <button style="margin-right: 5px" class="btn btn-full" ripple="ripple" type="submit" onclick="Javascript:if (document.form1.a.value=='delete') return hesk_confirmExecute('<?php echo hesk_makeJsString($hesklang['mo3']); ?>?');">
