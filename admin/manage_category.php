...
<div class="main__content categories category-create">
    ...
    <div class="table-wrap">
        <form method="post" class="form <?php echo isset($_SESSION['iserror']) ? 'invalid' : ''; ?>" action="manage_category.php" name="create-form">
            ...
            <div class="form-group">
                <label style="text-align: right"><?php echo $hesklang['aa_cat']; ?>:</label>
            ...
            <div id="select-users-window" style="display: <?php echo $category['autoassign'] === 1 && $category['autoassign_config'] !== null ? 'block' : 'none'; ?>">
                ...
                <div class="form-group">
                    <div class="radio-group">
                        <div class="radio-list" style="text-align: right">
                            <div class="radio-custom">
                                <input type="radio"
            ...
            <div class="form-group">
                <label style="text-align: right"><?php echo $hesklang['category_default_due_date']; ?>:</label>
                <input type="text"
                       class="form-control"
                       id="due-date-amount"
                       name="due-date-amount"
                       style="width:100px; margin-right:6px; margin-left:6px"
