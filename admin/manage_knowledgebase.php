                    ...
                    <li>
                        <div class="form-group">
                            ...
                            <div class="radio-list">
                                ...
                                <div style="margin-right: 24px; margin-bottom: 10px"><?php echo $hesklang['kb_published2']; ?></div>
                                <div class="radio-custom">
                                ...
                                <div style="margin-right: 24px; margin-bottom: 10px"><?php echo $hesklang['kb_private2']; ?></div>
                                <div class="radio-custom">
                                ...
                                <div style="margin-right: 24px; margin-bottom: 10px"><?php echo $hesklang['kb_draft2']; ?></div>
                            </div>
                        </div>
                    </li>
                    <li>
            ...
            <form class="form" action="manage_knowledgebase.php" method="post" name="form2">
                ...
                <div class="form-group">
                    ...
                    <div class="radio-list">
                        ...
                        <div style="margin-right: 24px; margin-bottom: 10px">
            ...
            <div class="category__list_table overflow-x-scroll" style="display: block">
                ...
                <table>
                    ...
                    if ($num == 0)
                    {
                        echo '
                            <tr>
                                <td colspan="4" style="padding-right: 10px">'.$hesklang['kb_no_dart'].'</td>
                            </tr>
                            ';
                    }
                    else
            ...
            <div class="category__list_table overflow-x-scroll" style="display: block">
                ...
                <table>
                    ...
                    if ($num == 0)
                    {
                        echo '
                            <tr>
                                <td colspan="4" style="padding-right: 10px">'.$hesklang['kb_no_part'].'</td>
                            </tr>
                            ';
                    }
                    else
                    ...
                    <div class="attachments">
                        ...
                        if ( ! empty($article['attachments']))
                        {
                            ...
                            foreach ($att as $myatt)
                            {
                                ...
                                echo '
                                    <a class="tooltip" style="text-decoration: none; margin-right: 16px; margin-left: 6px" title="'.$hesklang['dela'].'" href="manage_knowledgebase.php?a=remove_kb_att&amp;id='.$id.'&amp;kb_att='.$att_id.'&amp;token='.hesk_token_echo(0).'" onclick="return hesk_confirmExecute(\''.hesk_makeJsString($hesklang['delatt']).'\');">
            ...
            <div class="category__list_table overflow-x-scroll" style="display: block">
                ...
                <table>
                    ...
                    if ($num == 0)
                    {
                        echo '
                        <tr>
                            <td colspan="4" style="padding-right: 10px">'.$hesklang['kb_no_art'].'</td>
                        </tr>
                        ';
                    }
                    else
