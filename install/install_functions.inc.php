...
function hesk_iDatabase($problem=0)
{
	...
	if (INSTALL_PAGE == 'install.php')
	{
		...
		<tr>
		<td width="200">&nbsp;</td>
		<td style="text-align:left"><a href="javascript:void(0)" onclick="javascript:getElementById('admin_pass').value = hesk_randomPassword();">Generate a random password</a></td>
		</tr>
		</table>
