            ...
            <div class="contr">
                <div class="breadcrumbs__inner">
                    ...
                    <svg class="icon icon-chevron-left">
                        <use xlink:href="<?php echo TEMPLATE_PATH; ?>customer/img/sprite.svg#icon-chevron-left"></use>
                    </svg>
        ...
        <div class="main__content">
            <div class="contr">
                ...
                <div class="content">
                    ...
                    <?php else: ?>
                        <div class="block__head" style="padding-bottom: 32px; text-align: right ! important; display: block;">
                        ...
                        <?php if ($hesk_settings['kb_views'] || $hesk_settings['kb_rating']): ?>
                            <div class="rate">
                                <?php if ($hesk_settings['kb_views']): ?>
                                    <div style="margin-left: 10px; display: -ms-flexbox; display: flex;">
